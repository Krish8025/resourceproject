        ...
        <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-500">
            <div className="relative overflow-hidden rounded-2xl border border-border bg-card p-8 shadow-2xl backdrop-blur-xl">
                ...
                <div className="mt-6 border-t border-border pt-6 text-center text-sm">
                    ...
                    <Link href="/signup" className="mt-1 inline-block font-semibold text-[#1d9bf0] hover:text-[#1a8cd8]">
                        Create an account
                    </Link>
                </div>
            </div>
            ...
            <div className="-z-10 absolute -top-40 -left-40 h-80 w-80 rounded-full bg-[#1d9bf0]/10 blur-3xl" />
            <div className="-z-10 absolute -bottom-40 -right-40 h-80 w-80 rounded-full bg-[#1d9bf0]/5 blur-3xl" />
        </div>
    )
}

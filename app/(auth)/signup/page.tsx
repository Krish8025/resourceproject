        ...
        <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-500">
            <div className="relative overflow-hidden rounded-2xl border border-zinc-200 bg-white/50 p-8 shadow-2xl backdrop-blur-xl dark:border-zinc-800 dark:bg-zinc-900/50">
                ...
                <div className="mt-6 border-t border-zinc-200 pt-6 text-center text-sm dark:border-zinc-800">
                    ...
                    <Link href="/login" className="mt-1 inline-block font-semibold text-blue-600 hover:text-blue-500 dark:text-blue-400">
                        Sign in
                    </Link>
                </div>
            </div>
            ...
            <div className="-z-10 absolute -top-40 -right-40 h-80 w-80 rounded-full bg-blue-500/20 blur-3xl" />
            <div className="-z-10 absolute -bottom-40 -left-40 h-80 w-80 rounded-full bg-purple-500/20 blur-3xl" />
        </div>
    )
}
